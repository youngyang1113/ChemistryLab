      ...
      {(provided, snapshot) => (
        ...
        >
          ...
          <div
            ...
            style={{ backgroundColor: reagent.color, boxShadow: `0 0 4px ${reagent.color}` }}
          />
          ...
          {!isInBeaker && (
            <button
              ...
              className="absolute bottom-1.5 right-1.5 w-5 h-5 rounded-full bg-blue-500 text-white 
          ...
          <div className="text-[10px] font-semibold text-gray-500 tracking-wide mb-0.5">
            {categoryConfig.icon || "🧪"}
          </div>
